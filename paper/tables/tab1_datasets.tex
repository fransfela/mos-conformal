\begin{table}[t]
  ...
  \caption{NISQA Corpus subsets used in the study~\cite{Mittag2021nisqa}. V-SIM is deterministically divided into disjoint calibration and in-domain evaluation halves. $N$ is the number of clips with subjective MOS labels.}
  \vspace{2pt}
  \label{tab:datasets}
